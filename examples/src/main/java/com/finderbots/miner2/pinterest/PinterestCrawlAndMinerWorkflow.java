...
public class PinterestCrawlAndMinerWorkflow {

    private static final Logger LOGGER = Logger.getLogger(PinterestCrawlAndMinerWorkflow.class);
    ...
    public static Flow createFlow(Path curWorkingDirPath, Path crawlDbPath, FetcherPolicy fetcherPolicy, UserAgent userAgent, BaseUrlFilter urlFilter, AnalyzeHtml analyzer, PinterestCrawlAndMinerTool.Options options) throws Throwable {
        ...
        Properties props = HadoopUtils.getDefaultProperties(PinterestCrawlAndMinerWorkflow.class, options.isDebugLogging(), conf);
