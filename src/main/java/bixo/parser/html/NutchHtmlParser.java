...
public class NutchHtmlParser implements IParser {
    public static final Logger LOGGER = Logger.getLogger(NutchHtmlParser.class);
    ...
    public NutchHtmlParser(String defaultEncoding, String cachingPolicy) {
