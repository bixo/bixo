...
import bixo.tools.sitecrawler.CreateUrlFromOutlinksFunction;
import bixo.tools.sitecrawler.LatestUrlBuffer;
import bixo.tools.sitecrawler.MetaData;
...
public class SimpleCrawlWorkflow {
    ...
    private static class SplitFetchedUnfetchedCrawlDatums implements ISplitter {
        ...
        public boolean isLHS(Tuple tuple) {
            CrawlDbDatum datum = new CrawlDbDatum(tuple);
