...
public class UrlImporterTest extends CascadingTestCase {
    ...
    public void testImportFiles() throws Exception {
        ...
        Hfs hfs = new Hfs(new SequenceFile(Constants.URL_TUPLE_ALL), workingFolder + "/" + Constants.URL_DB);
        ...
        hfs = new Hfs(new SequenceFile(Constants.URL_TUPLE_ALL), workingFolder + "/" + Constants.URL_DB);
